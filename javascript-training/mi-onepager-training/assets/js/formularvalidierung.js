...
function create_and_append_error_msg(input_element, error_msg) {
     ...
     * ##
     */
    var input_parent_element = input_element.parentElement /* 1. HIER */ ;
 ...
 * ##
 */
formular_element.addEventListener /* Hier */ ( /* und hier */ "submit", function (e) {
    ...
    /* ## Vorname */
    if ( /* HIER */ vorname_input_element.value === "" && vorname_input_element.value.length > 20) {
    ...
    /* ## Zuname */
    if ( /* HIER */ zuname_input_element.value === "") {
    ...
    /* ## Email */
    if ( /* HIER */ email_input_element.value === "" || !email_input_element.value.match(/.+@.+\..+/)) {
    ...
    /* ## Nachricht */
    if ( /* HIER */ nachricht_input_element.value === "") {
