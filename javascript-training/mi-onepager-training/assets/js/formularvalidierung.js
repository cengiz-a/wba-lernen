 ...
 * ##
 */
formular_element.addEvenetListener( "submit", ( e ) {
   ...
   if( vorname_input_element.value === "" || vorname_input_element.value.length > 20) {
    ...
    /* ## Email */
    if( email_input_element.value === "" || email_input_element.value.length > 20) {
    ...
    /* ## Nachricht */
    if( nachricht_input_element.value === "" || nachricht_input_element.value.length > 100) {
