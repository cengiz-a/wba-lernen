...
formular_element.addEventListener( "submit" , function( e ) {
    ...
    /* ## Zuname */
    if( /* HIER */ zuname_input_element.value === "" || zuname_input_element.value.length > 20 ) {
    ...
    /* ## Email */
    if(     /* HIER */email_input_element === "" || email_input_element.value.length > 20 
    ...
    /* ## Nachricht */
    if( /* HIER */nachricht_input_element === "" ) {
