 ...
 *  - Zeile 158   * Fehlerabfrage mittels einer if-Abfrage (done)
 *  - Zeile 192   * 'figure'-Element erzeugen (done)
 *  - Zeile 215   * 'figcaption'-Element erzeugen (done)
 *  - Zeile 227   * Erzeugung eines JavaScript-Objekts mittels der impliziten Kurzschreibweise
 *  - Zeile 256   * Vier Syntaxfehler beheben (done)
 */
